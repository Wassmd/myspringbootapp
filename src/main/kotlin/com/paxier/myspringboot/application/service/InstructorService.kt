...
class InstructorService(private val instructorRepository: InstructorRepositoryPort): InstructorServicePort {
    ...
    override fun findInstructorId(id: Long): Instructor? = instructorRepository.findById(id)
    override fun getAllInstructor(): List<Instructor> = instructorRepository.findAll()
